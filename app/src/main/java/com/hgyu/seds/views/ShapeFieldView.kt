...
import com.hgyu.seds.AbstractShape
...
import com.hgyu.seds.util.Tools.Companion.resolveFinalImageUrl
    ...
    private fun showImagePopup(imageUrl: String) {
        ...
        android.os.Handler(android.os.Looper.getMainLooper()).post {
            CoroutineScope(Dispatchers.IO).launch {
                try {
                    val url = URL(makeThumbnailUrl(imageUrl,900))
                    ...
                    val options = BitmapFactory.Options().apply {
                        inSampleSize = 1 // or 4, depending on image size
                    }
